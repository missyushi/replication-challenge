...
/* Create a pretty table */
	esttab using "ReplicationFolder_CJE_Covid/Tables/March_indexesInteracted_appendix_essentialWorkers.tex" ///
		, 	replace ///
		...
		delimiter("	&") ///
		prehead(`"\begin{tabular*}{\textwidth}{ @{\extracolsep{\fill}}l*{@span}{c}}"' `"\hline\hline"' `"\\"' `" &\multicolumn{4}{c}{Canada, Labour Force Survey} \\"' `"\cline{2-5} \\"' `"&\multicolumn{2}{c}{Real} &\multicolumn{2}{c}{Total Actual} \\"' `"&\multicolumn{2}{c}{Hourly Wage} &\multicolumn{2}{c}{Hours Worked Weekly} \\"' `"\cline{2-3} \cline{4-5} \\"' ) ///
		posthead(`"\hline"' `"\\"') ///
		prefoot(`"\\"') ///
